...
if (isset($_POST["edite"])):
    $edit['usu_id'] = filter_input(INPUT_POST, 'codigo', FILTER_SANITIZE_ENCODED);
    $edit['usu_nome'] = filter_input(INPUT_POST, 'nome', FILTER_SANITIZE_ENCODED);
    $edit['usu_email'] = filter_input(INPUT_POST, 'email', FILTER_SANITIZE_ENCODED);
    $edit['usu_login'] = filter_input(INPUT_POST, 'login', FILTER_SANITIZE_ENCODED);
    $edit['usu_senha'] = filter_input(INPUT_POST, 'senha', FILTER_SANITIZE_ENCODED);
    $edit['usu_nivel_acesso_id'] = filter_input(INPUT_POST, 'nivel_acesso', FILTER_SANITIZE_ENCODED);
    $edit["usu_update"] = filter_input(INPUT_POST, 'data_edit', FILTER_SANITIZE_ENCODED);
    $edit["usu_status"] = filter_input(INPUT_POST, 'status', FILTER_SANITIZE_ENCODED);

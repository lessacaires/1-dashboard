...
if (isset($_POST["cadastra"])):
    $cad['usu_nome'] = filter_input(INPUT_POST, 'nome', FILTER_SANITIZE_ENCODED);
    $cad['usu_email'] = filter_input(INPUT_POST, 'email', FILTER_SANITIZE_ENCODED);
    $cad['usu_login'] = filter_input(INPUT_POST, 'login', FILTER_SANITIZE_ENCODED);
    $cad['usu_senha'] = md5(filter_input(INPUT_POST, 'senha', FILTER_SANITIZE_ENCODED));
    $cad['usu_nivel_acesso_id'] = filter_input(INPUT_POST, 'nivel_acesso', FILTER_SANITIZE_ENCODED);
    $cad["usu_data_cad"] = filter_input(INPUT_POST, 'data_cad', FILTER_SANITIZE_ENCODED);
    $cad["usu_status"] = filter_input(INPUT_POST, 'status', FILTER_SANITIZE_ENCODED);

...
<?php
include_once(DOCUMENT_ROOT . '/lib/stdsql.php');
...
# Total de usuários
$numUsuarios = select($PDOCon, 'promotores');
...
$usuarios = select($PDOCon, 'usuarios', "LIMIT {$por_pagina} OFFSET {$inicio}");
?>
<div class="page-header">
    <div class="col-md-8">
                        ...
                        <form method="POST" action="proccess/edit-usuario.php" >
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col col-sm-6">
                                    ...
                                    <input type="text" class="form-control" name="data_edit" id="recipient-update" value="" readonly required>
                                </div>
                            </div>
